    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Satellite Not Found</h2>
          <p className="text-gray-600 mb-4">{error || 'The requested satellite could not be found.'}</p>
          <Link to="/satellites" className="text-indigo-600 hover:text-indigo-800">
            ← Back to Satellites
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800">{satellite.name}</h1>
                <div className="flex items-center gap-3 mt-2">
                  ...
                  <span className="text-gray-600">{satellite.type}</span>
                </div>
              </div>
            </div>
            {satellite.countryId && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <span className="text-sm text-gray-500">NORAD ID</span>
                  <p className="font-semibold text-gray-800">{satellite.noradId || 'N/A'}</p>
                </div>
                <div>
                  <span className="text-sm text-gray-500">COSPAR ID</span>
                  <p className="font-semibold text-gray-800">{satellite.cosparId || 'N/A'}</p>
                </div>
                <div>
                  <span className="text-sm text-gray-500">Country</span>
                  <p className="font-semibold text-gray-800">{satellite.countryId || 'N/A'}</p>
                </div>
                <div>
                  <span className="text-sm text-gray-500">Operator</span>
                  <p className="font-semibold text-gray-800">{satellite.operator || 'N/A'}</p>
                </div>
                {satellite.constellation && (
                  <div>
                    <span className="text-sm text-gray-500">Constellation</span>
                    <p className="font-semibold text-gray-800">{satellite.constellation}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            {/* Orbital Parameters */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Orbital Parameters</h2>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <span className="text-2xl font-bold text-indigo-600">
                    {satellite.altitude ? satellite.altitude.toLocaleString() : 'N/A'}
                  </span>
                  <p className="text-sm text-gray-500 mt-1">Altitude (km)</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <span className="text-2xl font-bold text-indigo-600">
                    {satellite.inclination ? `${satellite.inclination}°` : 'N/A'}
                  </span>
                  <p className="text-sm text-gray-500 mt-1">Inclination</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <span className="text-2xl font-bold text-indigo-600">
                    {satellite.orbitType || 'N/A'}
                  </span>
                  <p className="text-sm text-gray-500 mt-1">Orbit Type</p>
                </div>
              </div>
            </div>
            ...
            {satellite.purpose && (
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600">{satellite.purpose}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Physical Characteristics</h2>
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-gray-800">{satellite.type}</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            {/* Launch Information */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Launch Information</h2>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
            ...
            {/* Orbit Visualization */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Orbit Visualization</h2>
