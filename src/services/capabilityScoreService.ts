...
const MOCK_COUNTRIES: Country[] = [
  ...
  // Additional spacefaring nations
  {
    id: 'CAN',
    name: 'Canada',
    isoCode: 'CAN',
  ...
  },
  {
    ...
    budgetAsPercentOfGdp: 0.003,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 300,
    totalLaunches: 3,
    successfulLaunches: 0,
    launchSuccessRate: 0,
    humanSpaceflightCapable: false,
  ...
  },
  {
    ...
    annualBudgetUsd: 20000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 25,
    totalLaunches: 40,
    successfulLaunches: 37,
    launchSuccessRate: 92.5,
    humanSpaceflightCapable: false,
    independentLaunchCapable: true,
    reusableRocketCapable: false,
    deepSpaceCapable: false,
  ...
  },
  {
    ...
    isoCode: 'UAE',
    region: 'Middle East',
    spaceAgencyName: 'UAE Space Agency',
    spaceAgencyAcronym: 'UAESA',
  ...
  },
  {
    ...
    isoCode: 'ARG',
    region: 'South America',
    spaceAgencyName: 'National Space Activities Commission',
    spaceAgencyAcronym: 'CONAE',
    spaceAgencyFounded: 1991,
  ...
  },
  {
    ...
    isoCode: 'BEL',
    region: 'Europe',
    spaceAgencyName: 'Belgian Federal Science Policy Office',
    spaceAgencyAcronym: 'BELSPO',
    spaceAgencyFounded: 1962,
    annualBudgetUsd: 250000000,
    budgetAsPercentOfGdp: 0.05,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 100,
    totalLaunches: 0,
  ...
  },
  {
    ...
    isoCode: 'DNK',
    region: 'Europe',
    spaceAgencyName: 'Danish National Space Center',
    spaceAgencyAcronym: 'DTU Space',
    spaceAgencyFounded: 2005,
    annualBudgetUsd: 60000000,
    budgetAsPercentOfGdp: 0.02,
    activeAstronauts: 1,
    totalSpaceAgencyEmployees: 100,
    totalLaunches: 0,
  ...
  },
  {
    ...
    isoCode: 'AUT',
    region: 'Europe',
    spaceAgencyName: 'Austrian Space Agency',
    spaceAgencyAcronym: 'FFG',
    spaceAgencyFounded: 1972,
    annualBudgetUsd: 80000000,
    budgetAsPercentOfGdp: 0.02,
    activeAstronauts: 1,
  ...
  },
  {
    ...
    isoCode: 'CZE',
    region: 'Europe',
    spaceAgencyName: 'Czech Space Office',
    spaceAgencyAcronym: 'CSO',
    spaceAgencyFounded: 2003,
    annualBudgetUsd: 30000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'FIN',
    region: 'Europe',
    spaceAgencyName: 'Finnish Meteorological Institute',
    spaceAgencyAcronym: 'FMI',
    spaceAgencyFounded: 1838,
    annualBudgetUsd: 40000000,
    budgetAsPercentOfGdp: 0.02,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 30,
    totalLaunches: 0,
  ...
  },
  {
    ...
    isoCode: 'PRT',
    region: 'Europe',
    spaceAgencyName: 'Portuguese Space Agency',
    spaceAgencyAcronym: 'PT Space',
    spaceAgencyFounded: 2019,
    annualBudgetUsd: 25000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 25,
    totalLaunches: 0,
  ...
  },
  {
    ...
    isoCode: 'GRC',
    region: 'Europe',
    spaceAgencyName: 'Hellenic Space Center',
    spaceAgencyAcronym: 'HSC',
    spaceAgencyFounded: 2019,
    annualBudgetUsd: 20000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'TUR',
    region: 'Europe',
    spaceAgencyName: 'Turkish Space Agency',
    spaceAgencyAcronym: 'TUA',
    spaceAgencyFounded: 2018,
    annualBudgetUsd: 50000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 1,
  ...
  },
  {
    ...
    isoCode: 'SAU',
    region: 'Middle East',
    spaceAgencyName: 'Saudi Space Agency',
    spaceAgencyAcronym: 'SSA',
    spaceAgencyFounded: 2018,
    annualBudgetUsd: 100000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 2,
  ...
  },
  {
    ...
    isoCode: 'IDN',
    region: 'Asia',
    spaceAgencyName: 'National Institute of Aeronautics and Space',
    spaceAgencyAcronym: 'LAPAN',
    spaceAgencyFounded: 1963,
    annualBudgetUsd: 50000000,
    budgetAsPercentOfGdp: 0.005,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 800,
    totalLaunches: 0,
    successfulLaunches: 0,
    launchSuccessRate: 0,
    humanSpaceflightCapable: false,
  ...
  },
  {
    ...
    isoCode: 'MYS',
    region: 'Asia',
    spaceAgencyName: 'Malaysian Space Agency',
    spaceAgencyAcronym: 'MYSA',
    spaceAgencyFounded: 2002,
    annualBudgetUsd: 30000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 1,
    totalSpaceAgencyEmployees: 200,
  ...
  },
  {
    ...
    isoCode: 'THA',
    region: 'Asia',
    spaceAgencyName: 'Geo-Informatics and Space Technology Development Agency',
    spaceAgencyAcronym: 'GISTDA',
    spaceAgencyFounded: 2000,
    annualBudgetUsd: 40000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 400,
    totalLaunches: 0,
    successfulLaunches: 0,
    launchSuccessRate: 0,
    humanSpaceflightCapable: false,
  ...
  },
  {
    ...
    isoCode: 'VNM',
    region: 'Asia',
    spaceAgencyName: 'Vietnam National Space Center',
    spaceAgencyAcronym: 'VNSC',
    spaceAgencyFounded: 2006,
    annualBudgetUsd: 20000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 200,
  ...
  },
  {
    ...
    isoCode: 'PHL',
    region: 'Asia',
    spaceAgencyName: 'Philippine Space Agency',
    spaceAgencyAcronym: 'PhilSA',
    spaceAgencyFounded: 2019,
    annualBudgetUsd: 25000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'BGD',
    region: 'Asia',
    spaceAgencyName: 'Bangladesh Space Research and Remote Sensing Organization',
    spaceAgencyAcronym: 'SPARRSO',
    spaceAgencyFounded: 1980,
    annualBudgetUsd: 10000000,
    budgetAsPercentOfGdp: 0.003,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 300,
    totalLaunches: 0,
  ...
  },
  {
    ...
    isoCode: 'EGY',
    region: 'Africa',
    spaceAgencyName: 'Egyptian Space Agency',
    spaceAgencyAcronym: 'EgSA',
    spaceAgencyFounded: 2019,
    annualBudgetUsd: 60000000,
    budgetAsPercentOfGdp: 0.02,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'NGA',
    region: 'Africa',
    spaceAgencyName: 'National Space Research and Development Agency',
    spaceAgencyAcronym: 'NASRDA',
    spaceAgencyFounded: 1999,
    annualBudgetUsd: 50000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 300,
  ...
  },
  {
    ...
    isoCode: 'ZAF',
    region: 'Africa',
    spaceAgencyName: 'South African National Space Agency',
    spaceAgencyAcronym: 'SANSA',
    spaceAgencyFounded: 2010,
    annualBudgetUsd: 30000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'MEX',
    region: 'North America',
    spaceAgencyName: 'Mexican Space Agency',
    spaceAgencyAcronym: 'AEM',
    spaceAgencyFounded: 2010,
    annualBudgetUsd: 30000000,
    budgetAsPercentOfGdp: 0.003,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'CHL',
    region: 'South America',
    spaceAgencyName: 'Chilean Space Agency',
    spaceAgencyAcronym: 'ACE',
    spaceAgencyFounded: 2001,
  ...
  },
  {
    ...
    isoCode: 'COL',
    region: 'South America',
    spaceAgencyName: 'Colombian Space Commission',
    spaceAgencyAcronym: 'CCE',
    spaceAgencyFounded: 2006,
    annualBudgetUsd: 10000000,
    budgetAsPercentOfGdp: 0.003,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'PER',
    region: 'South America',
    spaceAgencyName: 'Peruvian Space Agency',
    spaceAgencyAcronym: 'CONIDA',
    spaceAgencyFounded: 1974,
    annualBudgetUsd: 8000000,
    budgetAsPercentOfGdp: 0.004,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 150,
    totalLaunches: 0,
    successfulLaunches: 0,
  ...
  },
  {
    ...
    isoCode: 'KAZ',
    region: 'Asia',
    spaceAgencyName: 'Kazcosmos',
    spaceAgencyAcronym: 'KazCosmos',
    spaceAgencyFounded: 2007,
    annualBudgetUsd: 40000000,
    budgetAsPercentOfGdp: 0.02,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 200,
  ...
  },
  {
    ...
    isoCode: 'HUN',
    region: 'Europe',
    spaceAgencyName: 'Hungarian Space Office',
    spaceAgencyAcronym: 'HSO',
    spaceAgencyFounded: 1992,
    annualBudgetUsd: 20000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'LUX',
    region: 'Europe',
    spaceAgencyName: 'Luxembourg Space Agency',
    spaceAgencyAcronym: 'LSA',
    spaceAgencyFounded: 2018,
    annualBudgetUsd: 100000000,
    budgetAsPercentOfGdp: 0.12,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'IRL',
    region: 'Europe',
    spaceAgencyName: 'Enterprise Ireland Space',
    spaceAgencyAcronym: 'EI Space',
    spaceAgencyFounded: 1975,
    annualBudgetUsd: 40000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
  ...
  },
  {
    ...
    isoCode: 'SGP',
    region: 'Asia',
    spaceAgencyName: 'Singapore Space and Technology Limited',
    spaceAgencyAcronym: 'SSTL',
    spaceAgencyFounded: 2015,
    annualBudgetUsd: 25000000,
    budgetAsPercentOfGdp: 0.01,
    activeAstronauts: 0,
    totalSpaceAgencyEmployees: 50,
  ...
  },
  {
    ...
    isoCode: 'TWN',
    region: 'Asia',
    spaceAgencyName: 'Taiwan Space Agency',
    spaceAgencyAcronym: 'TASA',
    spaceAgencyFounded: 1991,
    annualBudgetUsd: 150000000,
    budgetAsPercentOfGdp: 0.02,
    activeAstronauts: 0,
...
const COUNTRY_METRICS: Record<string, {
  ...
  CAN: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    engineCount: 0, maxIsp: 0, maxChamberPressure: 0, advancedCycleEngines: 0,
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 25, satelliteTypes: 3, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 2, manufacturingCenters: 3,
    indigenousTechScore: 40,
  },
  ITA: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    engineCount: 1, maxIsp: 300, maxChamberPressure: 50, advancedCycleEngines: 0,
    hasReusableEngine: false, propellantTypes: 1, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 30, satelliteTypes: 3, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 2, manufacturingCenters: 3,
    indigenousTechScore: 45,
  },
  AUS: {
    ...
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 15, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 1, trackingStations: 3, manufacturingCenters: 1,
    indigenousTechScore: 20,
  },
  BRA: {
    launchVehicles: 1, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    engineCount: 1, maxIsp: 250, maxChamberPressure: 0, advancedCycleEngines: 0,
    hasReusableEngine: false, propellantTypes: 1, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 10, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 1, trackingStations: 1, manufacturingCenters: 1,
    indigenousTechScore: 15,
  },
  NZL: {
    launchVehicles: 1, activeLaunchVehicles: 1, maxPayloadLeo: 300, launchesLastYear: 10,
    engineCount: 1, maxIsp: 343, maxChamberPressure: 0, advancedCycleEngines: 0,
    hasReusableEngine: false, propellantTypes: 1, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 5, satelliteTypes: 1, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 1, trackingStations: 1, manufacturingCenters: 1,
  ...
  UAE: {
    ...
    engineCount: 0, maxIsp: 0, maxChamberPressure: 0, advancedCycleEngines: 0,
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 1, planetaryMissions: 1, hasSampleReturn: false,
    maxProbeDistanceAU: 1.5, activeSatellites: 15, satelliteTypes: 3, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 1,
    indigenousTechScore: 30,
  },
  PRK: {
    launchVehicles: 2, activeLaunchVehicles: 1, maxPayloadLeo: 200, launchesLastYear: 1,
    engineCount: 1, maxIsp: 250, maxChamberPressure: 0, advancedCycleEngines: 0,
    hasReusableEngine: false, propellantTypes: 1, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 2, satelliteTypes: 1, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 1, trackingStations: 1, manufacturingCenters: 1,
    indigenousTechScore: 20,
  },
  UKR: {
    launchVehicles: 2, activeLaunchVehicles: 1, maxPayloadLeo: 6000, launchesLastYear: 0,
    engineCount: 3, maxIsp: 350, maxChamberPressure: 200, advancedCycleEngines: 1,
    hasReusableEngine: false, propellantTypes: 2, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 8, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 3,
    indigenousTechScore: 50,
  },
  ARG: {
    launchVehicles: 1, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    engineCount: 1, maxIsp: 200, maxChamberPressure: 0, advancedCycleEngines: 0,
    hasReusableEngine: false, propellantTypes: 1, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 10, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 1, trackingStations: 1, manufacturingCenters: 1,
  ...
  ESP: {
    ...
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 20, satelliteTypes: 3, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 2, manufacturingCenters: 2,
    indigenousTechScore: 25,
  },
  SWE: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    ...
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 15, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 1, trackingStations: 2, manufacturingCenters: 2,
    indigenousTechScore: 25,
  },
  NLD: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    ...
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 12, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 2,
    indigenousTechScore: 20,
  },
  BEL: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
  ...
  NOR: {
    ...
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 8, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 1, trackingStations: 2, manufacturingCenters: 1,
    indigenousTechScore: 18,
  },
  DNK: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    engineCount: 0, maxIsp: 0, maxChamberPressure: 0, advancedCycleEngines: 0,
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 6, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 1,
    indigenousTechScore: 15,
  },
  POL: {
    ...
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 5, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 1,
    indigenousTechScore: 12,
  },
  CHE: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    engineCount: 0, maxIsp: 0, maxChamberPressure: 0, advancedCycleEngines: 0,
  ...
  CZE: {
    ...
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 4, satelliteTypes: 1, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 1,
    indigenousTechScore: 12,
  },
  FIN: {
  ...
  PRT: {
    ...
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 3, satelliteTypes: 1, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 1,
    indigenousTechScore: 10,
  },
  GRC: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    engineCount: 0, maxIsp: 0, maxChamberPressure: 0, advancedCycleEngines: 0,
  ...
  TUR: {
    ...
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 12, satelliteTypes: 3, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 2,
    indigenousTechScore: 18,
  },
  SAU: {
    ...
    hasReusableEngine: false, propellantTypes: 0, crewedMissions: 0, longestMissionDays: 0,
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 15, satelliteTypes: 3, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 1,
    indigenousTechScore: 15,
  },
  IDN: {
  ...
  PHL: {
    ...
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 3, satelliteTypes: 1, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 1, manufacturingCenters: 0,
    indigenousTechScore: 5,
  },
  PAK: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
    engineCount: 0, maxIsp: 0, maxChamberPressure: 0, advancedCycleEngines: 0,
  ...
  ZAF: {
    ...
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 8, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 2, manufacturingCenters: 1,
    indigenousTechScore: 10,
  },
  MEX: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
  ...
  COL: {
    ...
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 2, satelliteTypes: 1, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 0, manufacturingCenters: 0,
    indigenousTechScore: 3,
  },
  PER: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
  ...
  LUX: {
    ...
    lunarMissions: 0, marsMissions: 0, planetaryMissions: 0, hasSampleReturn: false,
    maxProbeDistanceAU: 0, activeSatellites: 10, satelliteTypes: 2, hasGNSS: false,
    hasMegaConstellation: false, launchSites: 0, trackingStations: 0, manufacturingCenters: 1,
    indigenousTechScore: 18,
  },
  IRL: {
    launchVehicles: 0, activeLaunchVehicles: 0, maxPayloadLeo: 0, launchesLastYear: 0,
