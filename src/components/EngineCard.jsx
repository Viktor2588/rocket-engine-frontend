...
function getCycleColor(cycle) {
  if (!cycle) return 'bg-gray-100 dark:bg-gray-700 text-gray-700';
  ...
  return (
    <Link to={`/engines/${engine.id}`}>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
        ...
        {/* Footer */}
        <div className="bg-gray-50 dark:bg-gray-700 px-4 py-2 border-t flex justify-between items-center text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500">
          <span>
            {engine.propellant}
          </span>
          <span>
  ...
  return (
    <div
      ...
      className={`bg-white rounded-lg border p-3 cursor-pointer hover:bg-gray-50 dark:bg-gray-700 transition ${
        selected ? 'border-indigo-500 ring-2 ring-indigo-200' : 'border-gray-200 dark:border-gray-700'
      }`}
    >
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500">{engine.designer}</p>
        </div>
  ...
  return (
    <div className={`rounded-lg shadow p-4 ${colorClasses[color]}`}>
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500">{label}</span>
      </div>
